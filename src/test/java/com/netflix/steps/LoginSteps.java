...
public class LoginSteps extends NetflixBase {
	...
	@Then("I put my {string} in the email adress")
	public void i_put_my_in_the_email_adress(String string) {
	...
	WebElement signin = driver.findElement(By.xpath("//button[@class=\"btn login-button btn-submit btn-small\"]")); 
	signin.click();
	} 
